...
def mock_async_session_local(mock_session, monkeypatch):
    ...
    targets = [
        ...
        "app.bot.handlers.card_handlers.AsyncSessionLocal",
        "app.bot.handlers.common.AsyncSessionLocal",
        "app.bot.handlers.contact_handlers.AsyncSessionLocal",
        "app.bot.handlers.prompt_handlers.AsyncSessionLocal",
        "app.bot.handlers.search_handlers.AsyncSessionLocal",
        ...
        "app.bot.handlers.profile_handlers.AsyncSessionLocal",
        "app.bot.handlers.reminder_handlers.AsyncSessionLocal",
        "app.bot.handlers.assets_handler.AsyncSessionLocal",
        "app.bot.handlers.analytics_handlers.AsyncSessionLocal",
        "app.bot.handlers.match_handlers.AsyncSessionLocal",
        "app.bot.handlers.osint_handlers.AsyncSessionLocal",
        "app.bot.handlers.integration_handlers.AsyncSessionLocal",
